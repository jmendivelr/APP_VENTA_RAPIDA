...
public partial class ScanBarCodePage : ContentPage
{
    ...
    private void detectorImagen_BarcodesDetected(object sender, ZXing.Net.Maui.BarcodeDetectionEventArgs e)
    {
        ...
        if (e.Results.Any())
        {
            ...
            resultados.Add(new ProductoViewModel { Codigo = result.Value, Nombre = "Producto 3", Precio1 = 0, Precio2 = 0 ,Cantidad = 0, TotalPrecios=0 , TotalPreciosGeneral =0 , TotalPreciosSeleccionados=0 , PrecioTotal =0 });
