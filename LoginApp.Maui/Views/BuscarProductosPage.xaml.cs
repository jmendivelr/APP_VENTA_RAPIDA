...
{
    public ObservableCollection<ProductoViewModel> resultados = new ObservableCollection<ProductoViewModel>();

    public BuscarProductosPage()
    {
        InitializeComponent();
    }
    ...
    private async void Buscar_Clicked(object sender, EventArgs e)
    {
        ...
        using (HttpClient httpClient = new HttpClient())
        {
            ...
            resultados = JsonConvert.DeserializeObject<ObservableCollection<ProductoViewModel>>(jsonResult);
            resultadosLista.ItemsSource = resultados;
